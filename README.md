...
```
url = r"https://github.com/JinYSun/DeepAcceptor/releases/download/v1.0.0/ppcenos.pt"
wget.download(url,"tool/comget/ppcenos.pt")

wget.download(url,"tool/dap/OSC/test.ckpt")

wget.download(url,"tool/deepacceptor/deepacceptor.pkl")

wget.download(url,"tool/deepdonor/sm.pkl")

wget.download(url,"tool/deepdonor/pm.pkl")

wget.download(url,"tool/orbital/homo.pkl")

wget.download(url,"tool/orbital/lumo.pkl")
```
